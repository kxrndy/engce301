...
const config = {
  databaseURI: 'mongodb://wallboarduser:WB1qazxsw2@192.168.40.128:27017/wallboarddb',
  ...
  serverURL: 'https://172.22.197.235:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https://172.22.197.235:' + apiport + '/api',
  liveQuery: {
